...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='sumit9350',db='cv')
...
def run():
    st.markdown("""
    <section style="background: linear-gradient(135deg, #2980b9, #2c3e50); color: #fff; padding: 180px; text-align: center; border-top-left-radius: 20px; border-top-right-radius: 20px; border-bottom-left-radius: 50% 50px; border-bottom-right-radius: 50% 50px; width: 710px; height: 300px;">
    <h2>Get Your Resume Job Ready</h2>
    
    </section>
    """, unsafe_allow_html=True)
    
    # (Logo, Heading, Sidebar etc)
    # img = Image.open('./Logo/download.png')
    # st.image(img)
    # st.markdown('''<h5 style=linear-gradient(135deg, #2980b9, #2c3e50); color: #fff'> Upload Your Resume, And Get Smart Recommendations</h5>''',unsafe_allow_html=True)
    ...
    if choice == 'User':
        ...
        st.markdown('''<br><h5 style='text-align: left; color: #fff;'> Upload Your Resume, And Get Smart Recommendations</h5>''',unsafe_allow_html=True)
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with by 
            <a href="#" style="text-decoration: none; color: grey;">Sumit</a> through 
            <a href="#" style="text-decoration: none; color: grey;">(Data Scientist)</a>
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                # st.success("Welcome Sumit! Total %d " % values + " User's Have Used Our Tool : )")                
